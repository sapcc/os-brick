...
class VmdkConnectorTestCase(test_connector.ConnectorTestCase):
    ...
    def test_disconnect(
            ...
            get_disk_device, upload_vmdk, create_temp_ds_folder,
            get_ds_by_ref):
        ...
        self._connector._disconnect(
            backing, session, tmp_file_path, tmp_file, file_size, ds_ref,
            dc_ref, vmdk_path)
    ...
    def test_disconnect_volume(
        ...
        if import_data:
            ...
            backing, session, path, tmp_file, file_size, ds_ref, dc_ref,
                props['vmdk_path'])
